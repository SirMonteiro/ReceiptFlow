...
RSpec.describe "Visualização de gráficos", type: :feature do
  ...
  context "quando existem notas fiscais cadastradas" do
    before do
      create_list(:grafico_nota, 5, valor: 1000.0, emitida_em: Date.today)
      visit graficos_path
    end
  ...
  context "quando existe meta mensal" do
    before do
      create_list(:grafico_nota, 5, valor: 1000.0, emitida_em: Date.today.beginning_of_month)
      create(:meta, mes: Date.today.month, valor_meta: 6000.0)
      visit graficos_path
    end
