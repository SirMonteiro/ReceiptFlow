Feature: Acesso rápido aos dados das notas fiscais
  ...
  Scenario: Gerente acessa todos os dados das notas fiscais de um período específico
    ...
    And existem as seguintes notas fiscais:
      ...
      | 1      | Cliente Teste Ltda | R$ 1.520,75 | 35250512345678000123550010000012341000012345 | Venda de Mercadoria | Loja Exemplo | Cliente Teste Ltda | Produto A - 2x, Produto B - 3x | R$ 1.520,75    | R$ 230,12 | 5102 | 060 | 84713012 | TransFácil     | 05/10/2025 |
      | 2      | Beta Comércio      | R$ 820,30   | 35250512345678000123550010000012341000054321 | Venda de Serviço    | Loja Exemplo | Beta Comércio      | Serviço de instalação        | R$ 820,30      | R$ 123,04 | 5101 | 050 | 99999999 | EntregExpress  | 10/10/2025 |
