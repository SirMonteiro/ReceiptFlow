...
RSpec.describe ControleFinanceiroController, type: :controller do
  ...
  describe 'GET #index' do
    it 'atribui corretamente as variáveis de instância' do
      ...
      allow(@user).to receive_messages(metas_mensais: metas_mensais, orcamentos_mensais: orcamentos_mensais,
                                       despesas: despesas)
  ...
  describe 'POST #criar_despesa' do
    it 'cria uma nova despesa e redireciona' do
      ...
      post :criar_despesa, params: { despesa: { valor: 250, data: Time.zone.today, descricao: 'holocausto nuclear' } }
    ...
    it 'falha ao criar despesa e mostra alerta' do
      ...
      post :criar_despesa, params: { despesa: { valor: nil, data: Time.zone.today, descricao: 'holocausto nuclear' } }
